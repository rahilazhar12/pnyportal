...
const CompanySettings = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('https://plus.unsplash.com/premium_photo-1672423154405-5fd922c11af2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}
    >
          ...
          <div className="bg-white bg-opacity-70 backdrop-blur-lg p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-base font-semibold text-gray-800">{company.email}</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-sm text-gray-500 font-medium">Person in Contact</p>
                <p className="text-base font-semibold text-gray-800">
              ...
              <div>
                ...
                <p className="text-base font-semibold text-gray-800">{company.city}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-base font-semibold text-gray-800">{company.cnic}</p>
              </div>
            </div>
          </div>
        ) : (
          <p className="text-center text-white">Loading company information...</p>
        )}
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white bg-opacity-90 backdrop-blur-lg rounded-lg shadow-lg w-11/12 max-w-2xl p-6 relative">
              <h2 className="text-2xl font-bold text-gray-700 mb-6">Edit Company Info</h2>
              ...
              >
                <div className="grid gap-4">
                  {[ // Dynamic input fields
                    ...
                    { label: "Person in Contact", name: "personincontact", type: "text" },
                    ...
                    <div key={field.name}>
                      ...
                      <input
                        disabled={field.name === "ntnnumber" || field.name === "cnic"}
                        type={field.type}
                        name={field.name}
